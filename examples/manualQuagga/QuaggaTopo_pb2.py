...
_HOST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='path_to_bgpd_executable', full_name='Host.path_to_bgpd_executable', index=5,
